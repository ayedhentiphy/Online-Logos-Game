$(document).ready(function(){
	...
	*/
	...
	$("#picBB").click(function(){
		if(picBBcount % 2 == 1){
			picBBcount++;
			$("[id^='picBB']").attr('src', '../Pictures/Logos/Nescafe.JPG'); 
		}
		else{
			picBBcount++;
	...
	$("#picCC").click(function(){
		if(picCCcount % 2 == 1){
			picCCcount++;
			$("[id^='picCC']").attr('src', '../Pictures/Logos/Citreon.JPG'); 
		}
		else{
			picCCcount++;
	...
	$("#pic4").click(function(){
		if(pic4count % 2 == 1){
			pic4count++;
			$("[id^='pic4']").attr('src', '../Pictures/Logos/CNN.JPG'); 
		}
		else{
			pic4count++;
	...
	$("#pic5").click(function(){
		if(pic5count % 2 == 1){
			pic5count++;
			$("[id^='pic5']").attr('src', '../Pictures/Logos/TacoBell.JPG'); 
		}
		else{
			pic5count++;
	...
	$("#pic6").click(function(){
		if(pic6count % 2 == 1){
			pic6count++;
			$("[id^='pic6']").attr('src', '../Pictures/Logos/UnitedNations.JPG'); 
		}
		else{
			pic6count++;
	...
	$("#pic7").click(function(){
		if(pic7count % 2 == 1){
			pic7count++;
			$("[id^='pic7']").attr('src', '../Pictures/Logos/Panasonic.JPG'); 
		}
		else{
			pic7count++;
	...
	$("#pic8").click(function(){
		if(pic8count % 2 == 1){
			pic8count++;
			$("[id^='pic8']").attr('src', '../Pictures/Logos/Amazon.JPG'); 
		}
		else{
			pic8count++;
	...
	$("#pic9").click(function(){
		if(pic9count % 2 == 1){
			pic9count++;
			$("[id^='pic9']").attr('src', '../Pictures/Logos/Rossignol.JPG'); 
		}
		else{
			pic9count++;
	...
	$("#pic10").click(function(){
		if(pic10count % 2 == 1){
			pic10count++;
			$("[id^='pic10']").attr('src', '../Pictures/Logos/ABC.JPG'); 
		}
		else{
			pic10count++;
	...
	$("#pic11").click(function(){
		if(pic11count % 2 == 1){
			pic11count++;
			$("[id^='pic11']").attr('src', '../Pictures/Logos/AmericanEagle.JPG'); 
		}
		else{
			pic11count++;
	...
	$("#pic12").click(function(){
		if(pic12count % 2 == 1){
			pic12count++;
			$("[id^='pic12']").attr('src', '../Pictures/Logos/Reebok.JPG'); 
		}
		else{
			pic12count++;
	...
	$("#pic13").click(function(){
		if(pic13count % 2 == 1){
			pic13count++;
			$("[id^='pic13']").attr('src', '../Pictures/Logos/Axa.JPG'); 
		}
		else{
			pic13count++;
	...
	$("#pic14").click(function(){
		if(pic14count % 2 == 1){
			pic14count++;
			$("[id^='pic14']").attr('src', '../Pictures/Logos/Lays.JPG'); 
		}
		else{
			pic14count++;
	...
	$("#pic15").click(function(){
		if(pic15count % 2 == 1){
			pic15count++;
			$("[id^='pic15']").attr('src', '../Pictures/Logos/PizzaHut.JPG'); 
		}
		else{
			pic15count++;
	...
	$("#pic16").click(function(){
		if(pic16count % 2 == 1){
			pic16count++;
			$("[id^='pic16']").attr('src', '../Pictures/Logos/Harley.JPG'); 
		}
		else{
			pic16count++;
	...
	$("#pic17").click(function(){
		if(pic17count % 2 == 1){
			pic17count++;
			$("[id^='pic17']").attr('src', '../Pictures/Logos/WWF.JPG'); 
		}
		else{
			pic17count++;
	...
	$("#pic18").click(function(){
		if(pic18count % 2 == 1){
			pic18count++;
			$("[id^='pic18']").attr('src', '../Pictures/Logos/LandRover.JPG'); 
		}
		else{
			pic18count++;
	...
	$("#pic19").click(function(){
		if(pic19count % 2 == 1){
			pic19count++;
			$("[id^='pic19']").attr('src', '../Pictures/Logos/Ducati.JPG'); 
		}
		else{
			pic19count++;
	...
	$("#pic20").click(function(){
		if(pic20count % 2 == 1){
			pic20count++;
			$("[id^='pic20']").attr('src', '../Pictures/Logos/Starbucks.JPG'); 
		}
		else{
			pic20count++;
